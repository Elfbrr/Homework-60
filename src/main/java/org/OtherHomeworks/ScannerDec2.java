...
public class ScannerDec2 {public static void main(String[] args) {
    ...
    java.util.Scanner student = new java.util.Scanner(System.in);
    ...
    java.util.Scanner evenNumb = new java.util.Scanner(System.in);
